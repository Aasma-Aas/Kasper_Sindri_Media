  ...
  create view `site_dev`.`Tactical_pageviews_card_month_14_dbt__dbt_tmp`
...
CREATE PROCEDURE `prod`.`Tactical_pageviews_card_month_14_dbt`()
BEGIN
...
json_data as( 
select al.siteid as siteid, label_val label, hint_val  hint, al.value as valu,((al.value-alb.value)/al.value)*100 as chang, '' as progressCurrent , '' as progresstotal
from agg_last_30 al
