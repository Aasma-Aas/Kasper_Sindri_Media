  ...
  create view `site_dev`.`tactical_category_pageviews_chart_ytd_dbt__dbt_tmp`
...
CREATE DEFINER=`Site`@`%` PROCEDURE `tactical_category_pageviews_chart_ytd_17_test_dbt`()
BEGIN
