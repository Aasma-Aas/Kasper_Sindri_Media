...
{% set diction2 = {0: ['Opdater mig', 'Forbind mig', 'Help mig med at forsta', 'Giv mig en fordel','Underhold mig','Inspirer migg'], 1: ['Nyheder','Debat','Inspiration','Anmeldelser'],  2: ['skolepolitik', 'Psykisk arbejdsmiljø']} %}
{% set diction4 = {0: ['Opdater mig', 'Forbind mig', 'Hjælp mig med at forstå', 'Giv mig en fordel','Underhold mig','Inspirer mig'], 1: ['Nyheder','Debat','Inspiration','Anmeldelser'],  2: ['skolepolitik', 'Psykisk arbejdsmiljø']} %}
