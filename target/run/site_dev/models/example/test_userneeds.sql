...
BEGIN
	...
	last_30_days_article_published as(
		...
		CASE
            ...
            WHEN userneeds LIKE "%{'Opdater mig': 'Opdater mig'}%" THEN value.items()
        
            WHEN userneeds LIKE "%{'Forbind mig': 'Opdater mig'}%" THEN value.items()
        
            WHEN userneeds LIKE "%{'Hjælp mig med at forstå': 'Opdater mig'}%" THEN value.items()
        
            WHEN userneeds LIKE "%{'Giv mig en fordel': 'Opdater mig'}%" THEN value.items()
        
            WHEN userneeds LIKE "%{'Underhold mig': 'Opdater mig'}%" THEN value.items()
        
            WHEN userneeds LIKE "%{'Inspirer mig': 'Opdater mig'}%" THEN value.items()
        
    
        
            WHEN categories LIKE "%{'Nyheder': 'Opdater mig'}%" THEN value.items()
        
            WHEN categories LIKE "%{'Debat': 'Opdater mig'}%" THEN value.items()
        
            WHEN categories LIKE "%{'Inspiration': 'Opdater mig'}%" THEN value.items()
        
            WHEN categories LIKE "%{'Anmeldelser': 'Opdater mig'}%" THEN value.items()
        
    
        
            WHEN tags LIKE "%{'skolepolitik': 'Opdater mig'}%" THEN value.items()
        
            WHEN tags LIKE "%{'Psykisk arbejdsmiljø': 'Opdater mig'}%" THEN value.items()
