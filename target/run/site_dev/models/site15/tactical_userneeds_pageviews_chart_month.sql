  ...
  create view `site_dev`.`tactical_userneeds_pageviews_chart_month__dbt_tmp`
...
BEGIN
	...
	last_30_days_article_published as(
		...
		like
		  "%Opdater mig%" 
		 THEN "Opdater mig"  WHEN userneeds 
		like
		  "%Forbind mig%" 
		 THEN "Forbind mig"  WHEN userneeds 
		like
		  "%Help mig med at forsta%" 
		 THEN "Hjælp mig med at forstå"  WHEN userneeds 
		like
		  "%Hjælp mig med at forstå%" 
		 THEN "Hjælp mig med at forstå"  WHEN userneeds 
		like
		  "%Giv mig en fordel%" 
		 THEN "Giv mig en fordel"  WHEN userneeds 
		like
		  "%Underhold mig%" 
		 THEN "Underhold mig"  WHEN userneeds 
		like
		  "%Inspirer mig%" 
		 THEN "Inspirer mig" 
	...
	last_30_days_article_published_second as(
		...
		like
		  "%Leder%" 
		 THEN "Leder"  WHEN Categories 
		like
		  "%Presse%" 
		 THEN "Presse"  WHEN Categories 
		like
		  "%Privatansat%" 
		 THEN "Privatansat"  WHEN Categories 
		like
		  "%Plejefamilie%" 
		 THEN "Plejefamilie"  WHEN Categories 
		like
		  "%Tillidsrepræsentant%" 
		 THEN "Tillidsrepræsentant"  WHEN Categories 
		like
		  "%Lærere%" 
		 THEN "Lærere"  WHEN Categories 
		like
		  "%Arbejdsmiljørepræsentant%" 
		 THEN "Arbejdsmiljørepræsentant"  WHEN Categories 
		like
		  "%TRIO%" 
		 THEN "TRIO"  WHEN Categories 
		like
		  "%Senior%" 
		 THEN "Senior" 
	...
	last_30_days_article_published_third as(
		...
		"Børn og unge|Anbringelse|Sikrede institutioner"  THEN "Børn og unge"  WHEN Tags 
		REGEXP
		 
		"Socialpolitik|Nyheder|Forbund og a-kasse|Coronavirus"  THEN "Andet"  WHEN Tags 
		REGEXP
		 
		"Autisme|Udviklingshandicap|Botilbud|Magtanvendelse|Seksualitet|Domfældte"  THEN "Handicap"  WHEN Tags 
		REGEXP
		 
		"Psykiatri|Misbrug|Væresteder|Hjemløse|Herberg og forsorgshjem|Marginaliserede"  THEN "Psykiatri og udsathed"  WHEN Tags 
		REGEXP
		 
		"Socialpædagogisk faglighed|Socialpædagogisk praksis|Metoder og tilgange|Etik"  THEN "Socialpædagogisk faglighed"  WHEN Tags 
		REGEXP
		 
		"Ansættelsesvilkår|Opsigelse|Overenskomst|Arbejdstid|Løn|Ferie|Barsel|Senior |Ligestilling|Job og karriere|Uddannelse|Meritpædagoguddannelse|Kompetenceudvikling |Efteruddannelse|Arbejdsmiljø|Stress|Sygdom|Vold og trusler|Arbejdsskade|PTSD|A-kasse|Lønforsikring|Ledighed|Efterløn|Dagpenge|Arbejdsløshed"  THEN "Arbejdsliv og vilkår" 
